...
val x = Next("","")
      ...
      private lateinit var mlistener : madder.onitemclicklistener
class madder() : RecyclerView.Adapter<madder.myviewholder>() {
    ...
    override fun onBindViewHolder(holder: myviewholder, position: Int) {
        ...
        holder.itemView.textView.text = "${ mylist.hits[position].recipe.ingredients[0].food} ${mylist.hits[position].recipe.ingredientLines} "
